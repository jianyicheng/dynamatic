...
-- File created: Sun Jul 26 22:01:01 2020
...
begin
	...
	fork_0_dataInArray_0 <= std_logic_vector (resize(unsigned(add_2_dataOutArray_0),fork_0_dataInArray_0'length));
	...
	fork_7_dataInArray_0 <= std_logic_vector (resize(unsigned(icmp_3_dataOutArray_0),fork_7_dataInArray_0'length));
	...
	icmp_3_dataInArray_0 <= std_logic_vector (resize(unsigned(fork_0_dataOutArray_0),icmp_3_dataInArray_0'length));
	...
	phi_1_dataInArray_2 <= std_logic_vector (resize(unsigned(branch_1_dataOutArray_0),phi_1_dataInArray_2'length));
	...
	forkC_4_dataInArray_0 <= std_logic_vector (resize(unsigned(start_0_dataOutArray_0),forkC_4_dataInArray_0'length));
	...
	phiC_0_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_2_dataOutArray_0),phiC_0_dataInArray_0'length));
	...
	branch_0_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_0),branch_0_dataInArray_1'length));
	branchC_2_pValidArray_1 <= fork_5_validArray_1;
	fork_5_nReadyArray_1 <= branchC_2_readyArray_1;
	branchC_2_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_5_dataOutArray_1),branchC_2_dataInArray_1'length));

	phiC_0_clk <= clk;
	phiC_0_rst <= rst;
	buffA_1_pValidArray_0 <= phiC_0_validArray_0;
	phiC_0_nReadyArray_0 <= buffA_1_readyArray_0;
	buffA_1_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_0_dataOutArray_0),buffA_1_dataInArray_0'length));
	phi_1_pValidArray_0 <= phiC_0_validArray_1;
	phiC_0_nReadyArray_1 <= phi_1_readyArray_0;
	phi_1_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_0_dataOutArray_1),phi_1_dataInArray_0'length));
	...
	phiC_1_dataInArray_0 <= std_logic_vector (resize(unsigned(branchC_3_dataOutArray_1),phiC_1_dataInArray_0'length));

	fork_7_clk <= clk;
	fork_7_rst <= rst;
	branch_1_pValidArray_1 <= fork_7_validArray_0;
	fork_7_nReadyArray_0 <= branch_1_readyArray_1;
	branch_1_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_0),branch_1_dataInArray_1'length));
	branchC_3_pValidArray_1 <= fork_7_validArray_1;
	fork_7_nReadyArray_1 <= branchC_3_readyArray_1;
	branchC_3_dataInArray_1 <= std_logic_vector (resize(unsigned(fork_7_dataOutArray_1),branchC_3_dataInArray_1'length));

	phiC_1_clk <= clk;
	phiC_1_rst <= rst;
	ret_0_pValidArray_0 <= phiC_1_validArray_0;
	phiC_1_nReadyArray_0 <= ret_0_readyArray_0;
	ret_0_dataInArray_0 <= std_logic_vector (resize(unsigned(phiC_1_dataOutArray_0),ret_0_dataInArray_0'length));
	...
	add_2_dataInArray_0 <= std_logic_vector (resize(unsigned(buffI_0_dataOutArray_0),add_2_dataInArray_0'length));

	buffA_1_clk <= clk;
	buffA_1_rst <= rst;
	branchC_3_pValidArray_0 <= buffA_1_validArray_0;
	buffA_1_nReadyArray_0 <= branchC_3_readyArray_0;
	branchC_3_dataInArray_0 <= std_logic_vector (resize(unsigned(buffA_1_dataOutArray_0),branchC_3_dataInArray_0'length));
