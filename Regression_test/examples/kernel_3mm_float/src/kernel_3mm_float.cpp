...
void kernel_3mm_float(in_float_t A[N][N], in_float_t B[N][N], in_float_t C[N][N], in_float_t D[N][N], inout_float_t E[N][N], inout_float_t F[N][N], out_float_t G[N][N])
...
int main(void){
    ...
    out_float_t G[AMOUNT_OF_TEST][N][N];
