...
void kernel_2mm_float(in_float_t alpha, in_float_t beta, inout_float_t tmp[N][N], in_float_t A[N][N], in_float_t B[N][N], in_float_t C[N][N], out_float_t D[N][N])
{
  int i, j, k;
...
int main(void){
    ...
    out_float_t D[AMOUNT_OF_TEST][N][N];
